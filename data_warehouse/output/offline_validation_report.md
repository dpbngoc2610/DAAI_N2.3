...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| `customers` | 121,930 | 121,930 | 0 | 0 | 0 | PASS |
| `geography` | 39,948 | 39,948 | 0 | 0 | 0 | PASS |
| `products` | 2,412 | 2,412 | 0 | 0 | 426 | PASS |
| `promotions` | 50 | 50 | 0 | 0 | 0 | PASS |
| `orders_enriched` | 646,945 | 646,945 | 0 | 0 | 0 | PASS |
| `order_items` | 714,669 | 714,669 | 0 | 0 | 0 | PASS |
| `payments` | 646,945 | 646,945 | 0 | 0 | 0 | PASS |
| `returns` | 39,939 | 39,939 | 0 | 0 | 4,423 | PASS |
| `reviews` | 113,551 | 113,551 | 0 | 0 | 0 | PASS |
| `shipments` | 566,067 | 566,067 | 0 | 0 | 519,276 | PASS |
| `inventory` | 60,247 | 60,247 | 0 | 0 | 782 | PASS |
| `web_traffic` | 3,652 | 3,652 | 0 | 0 | 0 | PASS |
